...
export const RANK_TIERS: readonly RankTier[] = [
  ...
  { name: 'Acolyte', start: 31, end: 36 },
  { name: 'Sentinel', start: 41, end: 46 },
  { name: 'Mystic', start: 51, end: 56 },
  { name: 'Ritualist', start: 61, end: 66 },
  { name: 'Emissary', start: 71, end: 76 },
...
export const TIER_COLORS: Record<string, string> = {
  ...
  Acolyte: 'rgb(92, 109, 171)',
  Sentinel: 'rgb(113, 156, 71)',
  Mystic: 'rgb(221, 163, 38)',
  Ritualist: 'rgb(238, 79, 87)',
  Emissary: 'rgb(180, 127, 235)',
  Oracle: 'rgb(149, 81, 56)',
  Phantom: 'rgb(124, 124, 124)',
  Ascendant: 'rgb(195, 151, 81)',
  Eternus: 'rgb(92, 233, 169)',
